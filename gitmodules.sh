...
cp -R $TMP_DIR/icingaweb2/icingaweb2-master/modules/monitoring /etc/icingaweb2/modules/
cp -R  $TMP_DIR/icingaweb2/icingaweb2-master/modules/doc /etc/icingaweb2/modules/
